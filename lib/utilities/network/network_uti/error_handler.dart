...
class ExceptionHandle {
  ...
  static final Map<int, ApiFailure> _errorMap = <int, ApiFailure>{
    ...
    badGateway: const ApiFailure(badGateway, 'bad_gateway', 'Không kết nối được với máy chủ\nvui lòng thử lại sau.'),
    serviceUnavailable: const ApiFailure(
        serviceUnavailable, 'service_unavailable', 'Không kết nối được với máy chủ. Vui lòng đăng nhập lại.'),
    gatewayTimeout:
    const ApiFailure(gatewayTimeout, 'gateway_timeout', 'Không nhận được phản hồi từ máy chủ\nVui lòng thử lại sau.')
  };
